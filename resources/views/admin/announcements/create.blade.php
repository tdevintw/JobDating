      ...
      <form class="w-full max-w-lg" action="{{ route('announcements.store') }}" method="POST">
          @csrf
            ...
            <div class="w-full md:w-1/2 px-3">
              ...
              <input type="text" name="company_id" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text">
            </div>
            @if ($errors->any())
